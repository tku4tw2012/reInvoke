...
#
# Build the static ARMv7 reInvoke provisioning daemon.
...
Options:
  ...
  --component NAME     provisiond, wifi-applyd, or networkd (default: provisiond)
...
main() {
  ...
  case "${component}" in
    ...
    networkd)
      ...
      ;;
    *)
      err "--component must be provisiond, wifi-applyd, or networkd"
      ;;
  esac
