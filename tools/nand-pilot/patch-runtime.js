...
log "NAND pilot RC12 runtime dispatched; health and NAND origin require evidence, not this message"`);
  ...
  replace([
    ...
    '        # -r takes its size attached: "-r 256" parses as a bare -r,',
    '        # which rotates every 16 KB and threw away the history that',
    '        # made a defect explainable. Four rotations of 256 KB keep',
    '        # roughly a megabyte of the donor stack log.',
