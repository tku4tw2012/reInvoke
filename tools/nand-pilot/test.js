...
try {
  ...
  assert.equal(lib.CANDIDATE, '05.2');
  assert.equal(lib.BUILD_ID, 'reInvoke-NAND-05.2-20260914');
  assert.equal(lib.BLUETOOTH_NAME, 'reInvoke-NAND-05.2');
  assert.equal(lib.BUNDLE_NAME, '83_IMAGE.reinvoke-05.2');
