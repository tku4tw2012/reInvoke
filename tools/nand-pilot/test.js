...
try {
  ...
  assert.equal(lib.CANDIDATE, '06.0');
  assert.equal(lib.BUILD_ID, 'reInvoke-NAND-06.0-20260914');
  assert.equal(lib.BLUETOOTH_NAME, 'reInvoke-NAND-06.0');
  assert.equal(lib.BUNDLE_NAME, '83_IMAGE.reinvoke-06.0');
