...
try {
  ...
  assert.equal(lib.CANDIDATE, '05.8.8');
  assert.equal(lib.BUILD_ID, 'reInvoke-NAND-05.8.8-20260917');
  assert.equal(lib.BLUETOOTH_NAME, 'reInvoke-NAND-05.8.8');
  assert.equal(lib.BUNDLE_NAME, '83_IMAGE.reinvoke-05.8.8');
